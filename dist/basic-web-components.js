    ...
    value: function collectiveChanged() {
      if (this.collective.outermostElement === this) {
        ...
        if (!this.getAttribute('aria-label')) {
          ...
          var labels = this.collective.elements.map(function (element) {
