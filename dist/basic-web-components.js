...
exports.default = function (base) {
  return (function (_base) {
    ...
    _createClass(KeyboardPaging, [{
      ...
      get: function get() {
        // Prefer base result.
        return 'scrollTarget' in base.prototype ? _get(Object.getPrototypeOf(KeyboardPaging.prototype), 'scrollTarget', this) : this;
      },
      set: function set(element) {
        if ('scrollTarget' in base.prototype) {
          _set(Object.getPrototypeOf(KeyboardPaging.prototype), 'scrollTarget', element, this);
        }
      }
    }]);
